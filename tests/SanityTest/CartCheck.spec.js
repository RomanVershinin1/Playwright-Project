...
test.describe('PositiveTest', () => {
    test(`Test1`, async ({page}) => {
        ...
        ).toHaveText('2') // this validation is redundant. you already validate this before you entered the cart page.
        ...
        await page.locator('[data-test="firstName"]').click() // click is unnecessary. the fill action doing it already
        await page.locator('[data-test="firstName"]').fill('Roman')
        await page.locator('[data-test="lastName"]').click() // click is unnecessary. the fill action doing it already
        await page.locator('[data-test="lastName"]').fill('Vershinin')
        await page.locator('[data-test="postalCode"]').click() // click is unnecessary. the fill action doing it already
